...
JFLAGS="-Xms2G -Xmx20G -Dtornado.kernels.coarsener=False -Dtornado.enable.fix.reads=False -Dtornado.compiler.fullInlining=True -Dlog4j.configurationFile=${KFUSION_ROOT}/conf/log4j2.xml -Dtornado.benchmarking=False -Dtornado.profiler=False -Dtornado.log.profiler=False"
