    ...
    public void configure(final Device device) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            trackingPyramidGraphs[i] = new TaskGraph("icp" + i)
                    ...
                    .transferToHost(DataTransferMode.EVERY_EXECUTION, icpResultIntermediate1, trackingResults[i]);
        ...
        renderGraph = new TaskGraph("render")
                .transferToDevice(DataTransferMode.EVERY_EXECUTION, scenePose, verticies, normals, volume,
                        pyramidVerticies[0], pyramidNormals[0], trackingResults[0], pyramidDepths[0])
